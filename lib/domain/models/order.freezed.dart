...
class _Order implements Order {
  const _Order({required this.id, required this.orderNumber, required this.hikeId, required this.userId, required this.totalAmount, required this.deliveryType, required this.status, required this.createdAt, this.estimatedDelivery, this.trackingNumber, final  Map<String, dynamic>? deliveryAddress, this.paymentIntentId, this.updatedAt}): _deliveryAddress = deliveryAddress;
