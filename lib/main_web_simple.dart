...
/// Einfache Web-Version der App ohne problematische Dependencies
void main() {
  runApp(const WhiskyHikesWebAppSimple());
}

class WhiskyHikesWebAppSimple extends StatelessWidget {
  const WhiskyHikesWebAppSimple({super.key});
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: MaterialApp(
        title: 'Whisky Hikes - Web Admin (Simple)',
        theme: ThemeData(
          primarySwatch: Colors.amber,
          useMaterial3: true,
        ),
        home: const WebHomePageSimple(),
      ),
    );
  }
}
...
class WebHomePageSimple extends StatelessWidget {
  const WebHomePageSimple({super.key});
