...
void main() {
  group('Payment Routes Tests (TDD - Red Phase)', () {
      ...
      router = GoRouter(
        routes: [
          ...
          GoRoute(
            ...
            name: 'payment-failed', 
            builder: (context, state) {
              final errorMessage = state.uri.queryParameters['error'] ?? 'Unbekannter Fehler';
              return Scaffold(
                body: Center(
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
    ...
    group('Route Configuration Tests', () {
      testWidgets('should have checkout route configured', (WidgetTester tester) async {
      ...
      testWidgets('should handle checkout route without order data', (WidgetTester tester) async {
      ...
      testWidgets('should have payment success route configured', (WidgetTester tester) async {
      ...
      testWidgets('should have payment failed route configured', (WidgetTester tester) async {
      ...
      testWidgets('should have order history route configured', (WidgetTester tester) async {
    ...
    group('Navigation Flow Tests', () {
      testWidgets('should navigate from home to checkout with order data', (WidgetTester tester) async {
        // Arrange
        final testOrder = BasicOrder(
          id: 456,
        ...
        expect(find.text('Checkout'), findsOneWidget);
        expect(find.text('30,99'), findsOneWidget); // Order amount should be displayed
      });

      testWidgets('should navigate to success page after successful payment', (WidgetTester tester) async {
      ...
      testWidgets('should navigate to failed page and allow retry', (WidgetTester tester) async {
        // Arrange
        await tester.pumpWidget(createTestApp());
        router.go('/checkout'); // Start at checkout (without order - will show error)
        await tester.pumpAndSettle();
        ...
        expect(find.text('Order not found'), findsOneWidget); // Our test checkout state
      });
    });

    group('Route Parameter Handling Tests', () {
      testWidgets('should handle query parameters in payment failed route', (WidgetTester tester) async {
      ...
      testWidgets('should handle missing query parameters gracefully', (WidgetTester tester) async {
      ...
      testWidgets('should pass order data correctly to checkout page', (WidgetTester tester) async {
    ...
    group('Navigation State Management Tests', () {
      testWidgets('should maintain proper navigation stack', (WidgetTester tester) async {
    ...
    group('Error Handling Tests', () {
      ...
      testWidgets('should handle navigation with invalid data types', (WidgetTester tester) async {
