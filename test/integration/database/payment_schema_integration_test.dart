...
void main() {
  group('Payment Database Schema Integration Tests (TDD - GREEN Phase)', () {
    ...
    group('Orders Table Integration', () {
      ...
      test('should validate order status enum constraints', () async {
        ...
        try {
          ...
          expect(e.toString(), anyOf([contains('violates check constraint')]));
        }
      });
    ...
    group('Foreign Key Relationships Integration', () {
      test(
        'should enforce foreign key constraint from orders to hikes',
        () async {
      ...
      test(
        'should enforce foreign key constraint from order_items to orders',
        () async {
      ...
      test(
        'should enforce foreign key constraint from payments to orders',
        () async {
