  ...
  group('WhiskyManagementProvider', () {
    ...
    group('Initialization', () {
      ...
      test('should load tasting sets on initialization', () async {
        ...
        when(mockService.getAllTastingSets())
            .thenAnswer((_) async => testSets);
    ...
    group('Tasting Set Management', () {
      test('should create tasting set successfully', () async {
        ...
        when(mockService.createTastingSet(newSet))
      ...
      test('should update tasting set successfully', () async {
        ...
        when(mockService.updateTastingSet(updatedSet))
        ...
        expect(provider.tastingSets.first.name, equals('Updated Highland Collection'));
      ...
      test('should delete tasting set successfully', () async {
        ...
        when(mockService.deleteTastingSet(1))
            .thenAnswer((_) async {});
        when(mockService.getAllTastingSets())
      ...
      test('should get tasting set by hike ID', () async {
        ...
        when(mockService.getTastingSetByHikeId(100))
    ...
    group('Whisky Sample Management', () {
      test('should load whisky samples for tasting set', () async {
        ...
        when(mockService.getWhiskySamplesByTastingSetId(1))
      ...
      test('should create whisky sample successfully', () async {
        ...
        when(mockService.createWhiskySample(newSample))
      ...
      test('should update whisky sample successfully', () async {
        ...
        when(mockService.updateWhiskySample(updatedSample))
        ...
        expect(provider.whiskySamples.first.name, equals('Updated Glenfiddich 12'));
      ...
      test('should delete whisky sample successfully', () async {
        ...
        when(mockService.deleteWhiskySample(1))
            .thenAnswer((_) async {});
        when(mockService.getWhiskySamplesByTastingSetId(1))
      ...
      test('should reorder whisky samples successfully', () async {
        ...
        when(mockService.updateSampleOrder(reorderedSamples))
            .thenAnswer((_) async {});
        when(mockService.getWhiskySamplesByTastingSetId(1))
    ...
    group('Search and Filtering', () {
      ...
      test('should filter tasting sets by search query', () async {
        ...
        when(mockService.getAllTastingSets())
            .thenAnswer((_) async => allSets);
        when(mockService.searchTastingSets('Highland'))
    ...
    group('Sorting', () {
      test('should sort by name ascending by default', () async {
        ...
        final sortedNames = provider.filteredTastingSets.map((set) => set.name).toList();
    ...
    group('Image Management', () {
      test('should upload whisky image successfully', () async {
        final imageBytes = Uint8List.fromList(List.generate(100, (index) => index % 256));
        const imageUrl = 'https://storage.example.com/whisky_123.jpg';

        when(mockService.uploadWhiskyImage(123, imageBytes, 'jpg'))
      ...
      test('should upload tasting set image successfully', () async {
        ...
        when(mockService.uploadTastingSetImage(456, imageBytes, 'jpg'))
            .thenAnswer((_) async => imageUrl);

        final result = await provider.uploadTastingSetImage(456, imageBytes, 'jpg');

        expect(result, equals(imageUrl));
        verify(mockService.uploadTastingSetImage(456, imageBytes, 'jpg')).called(1);
      });
    ...
    group('Statistics', () {
      test('should load tasting set statistics', () async {
        ...
        when(mockService.getTastingSetStatistics())
      ...
      test('should load popular distilleries', () async {
        ...
        when(mockService.getPopularDistilleries(limit: 10))
        ...
        expect(provider.popularDistilleries.first['distillery'], equals('Macallan'));
    ...
    group('Error Handling', () {
      test('should handle service errors during CRUD operations', () async {
        ...
        when(mockService.createTastingSet(testSet))
